...
namespace Training.ViewModels
{
    public class UsersViewModel : BaseViewModel
    {
        ...
        {
            Title = "Users";
            var p = (TaskListItemViewModel)(Shell.Current?.CurrentItem?.CurrentItem as IShellSectionController)?.PresentedPage?.BindingContext;
            UsersDataStore.LoadItems(p.ListItemId);
